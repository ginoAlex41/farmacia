...
class Proveedor{
    ...
    function crear($nombre,$telefono,$correo,$direccion,$foto){
        ...
        if(!empty($this->objetos)){
            ...
            $sql="INSERT INTO proveedor(nombre,telefono,correo,direccion,foto) values (:nombre,:telefono,:correo,:direccion,:foto);";
            $query = $this->acceso->prepare($sql);
            $query->execute(array(':nombre'=>$nombre,':foto'=>$foto,':telefono'=>$telefono,':correo'=>$correo,':direccion'=>$direccion));
            echo 'add';
        }
    }
    function buscar(){
    ...
    function cambiar_logo($id,$nombre){
        $sql="UPDATE proveedor SET foto=:nombre where id_proveedor=:id";
        $query=$this->acceso->prepare($sql);
