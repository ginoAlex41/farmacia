...
class Lote
{
  ...
  function buscar()
  {
    if (!empty($_POST['consulta'])) {
      ...
      $sql = "SELECT l.id as id_lote,concat(l.id,' | ',l.codigo) as codigo,cantidad_lote, vencimiento, concentracion, obs, producto.nombre as prod_nom, laboratorio.nombre as lab_nom, tipo_producto.nombre as tip_nom,
            presentacion.nombre as pre_nom, proveedor.nombre as proveedor, producto.foto as logo
            FROM lote as l
  ...
  function ver($id)
  {
    $sql = "SELECT l.codigo as codigo, l.cantidad as cantidad, vencimiento, precio_compra, p.nombre as producto, concentracion,obs,
