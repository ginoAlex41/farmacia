                ...
                <h6>Codigo ${lote.codigo}</h6>
                    ...
                    <div class="row">
                      <div class="col-7">
                        ...
                        <ul class="ml-4 mb-0 fa-ul">
                          ...
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-prescription-bottle-alt"></i></span> obs: ${lote.obs}</li>
                      ...
                      <div class="col-5 text-center">
                        <img src="${lote.foto}" alt="" class="img-circle img-fluid">
                      </div>
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="text-right">
                      ...
                      <button class="editar btn btn-sm btn-success"type="buttton" data-toggle="modal" data-target="#editarlote">
