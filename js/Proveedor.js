$(document).ready(function() {
    ...
    function buscar_prov(consulta) {
        ...
        $.post('../controlador/ProveedorController.php', { consulta, funcion }, (response) => {
            ...
            proveedores.forEach(proveedor => {
                template += `
                <div provId="${proveedor.id}"provNombre="${proveedor.nombre}"provTelefono="${proveedor.telefono}"provCorreo="${proveedor.correo}"provDireccion="${proveedor.direccion}"provfoto="${proveedor.foto}"class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-5 text-center">
                      <img src="${proveedor.foto}" alt="" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
                <div class="card-footer">
                  <div class="text-right">
                    <button class="foto btn btn-sm btn-info" title="Editar logo" type="button" data-toggle="modal" data-target="#cambiologo">
    ...
    $(document).on('click', '.foto', (e) => {
        ...
        const foto = $(elemento).attr('provfoto');
