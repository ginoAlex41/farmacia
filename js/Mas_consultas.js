$(document).ready(function() {
    ...
    async function producto_mas_vendido() {
        ...
        let datos = {
            ...
            datasets: [{
                    label: lista[0].nombre + lista[0].concentracion + lista[0].obs,
                ...
                {
                    label: lista[1].nombre + lista[1].concentracion + lista[1].obs,
                ...
                {
                    label: lista[2].nombre + lista[2].concentracion + lista[2].obs,
                ...
                {
                    label: lista[3].nombre + lista[3].concentracion + lista[3].obs,
                ...
                {
                    label: lista[4].nombre + lista[4].concentracion + lista[4].obs,
