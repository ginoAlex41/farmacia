$(document).ready(function() {
    ...
    function buscar_lab(consulta) {
        ...
        $.post('../controlador/LaboratorioController.php', { consulta, funcion }, (response) => {
            ...
            laboratorios.forEach(laboratorio => {
                template += `
                    <tr labId="${laboratorio.id}" labNombre="${laboratorio.nombre}" labfoto="${laboratorio.foto}">
                        <td>
                            <button class="foto btn btn-info" title="Cambiar logo de laboratorio" type="button" data-toggle="modal" data-target="#cambiologo">
                        ...
                        <td>
                            <img src="${laboratorio.foto}" class="img-fluid rounded" width="70" heigth="70">
                        </td>
    ...
    $(document).on('click', '.foto', (e) => {
        ...
        const foto = $(elemento).attr('labfoto');
