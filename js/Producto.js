$(document).ready(function() {
    ...
    $('#form-crear-producto').submit(e => {
        ...
        $.post('../controlador/ProductoController.php', { funcion, id, nombre, concentracion, obs, precio, laboratorio, tipo, presentacion }, (response) => {
            if (response == 'add') {
                $('#add').hide('slow');
                $('#add').show(1000);
                $('#add').hide(2000);
                    ...
                    <div class="row">
                      <div class="col-7">
                        ...
                        <ul class="ml-4 mb-0 fa-ul text-muted">
                          ...
                          <li class="small"><span class="fa-li"><i class="fas fa-lg fa-prescription-bottle-alt"></i></span> obs: ${producto.obs}</li>
                      ...
                      <div class="col-5 text-center">
                        <img src="${producto.foto}" alt="" class="img-circle img-fluid">
                      </div>
                    </div>
                  </div>
                  <div class="card-footer">
                    <div class="text-right">
                      <button class="foto btn btn-sm bg-teal" type="buttton" data-toggle="modal" data-target="#cambiologo">
    ...
    $(document).on('click', '.foto', (e) => {
        funcion = "cambiar_foto";
        const elemento = $(this)[0].activeElement.parentElement.parentElement.parentElement.parentElement;
        const id = $(elemento).attr('prodId');
        const foto = $(elemento).attr('prodfoto');
        const nombre = $(elemento).attr('prodNombre');
        $('#funcion').val(funcion);
        $('#id_logo_prod').val(id);
        $('#foto').val(foto);
        $('#logoactual').attr('src', foto);
    ...
    $(document).on('click', '.editar', (e) => {
        ...
        const obs = $(elemento).attr('prodobs');
