        ...
        <div class="card card-success">
          ...
          <div class="card-body">
            ...
            <form id="form-editar">
              ...
              <div class="form-group">
                <label for="obs_edit">obs</label>
                <input id="obs_edit" type="text" class="form-control" placeholder="Ingrese obs" required>
              </div>
          ...
          <div class="card-body">
            ...
            <form id="form-crear">
              ...
              <div class="form-group">
                ...
                <input id="ci" type="number" class="form-control" placeholder="Ingrese ci" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input id="obs" type="text" class="form-control" placeholder="Ingrese obs" required>
              </div>
