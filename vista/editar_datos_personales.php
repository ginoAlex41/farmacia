            ...
            <div class="col-md-3">
              <div class="card card-success card-outline">
                <div class="card-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                      <b style="color:#0B7300">ci</b><a id="ci_us" class="float-right">12</a>
                    </li>
                    <li class="list-group-item">
              ...
              <div class="card card-success">
                ...
                <div class="card-body">
                  ...
                  <strong style="color:#0B7300">
                    <i class="fas fa-pencil-alt mr-1"></i>Informacion obs
                  </strong>
                  <p id="obs_us" class="text-muted">4234234</p>
              ...
              <div class="card card-success">
                ...
                <div class="card-body">
                  ...
                  <form id='form-usuario' class="form-horizontal">
                    ...
                    <div class="form-group row">
                      <label for="obs" class="col-sm-2 col-form-label">Informacion obs</label>
                      <div class="col-sm-10">
                        <textarea class="form-control" id="obs" cols="30" rows="10"></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
