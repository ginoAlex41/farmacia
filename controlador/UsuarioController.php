...
if ($_POST['funcion'] == 'editar_usuario') {
  ...
  $sexo = $_POST['sexo'];
  $obs = $_POST['obs'];
  $usuario->editar($id_usuario, $telefono, $residencia, $correo, $sexo, $obs);
  echo 'editado';
}
...
if ($_POST['funcion'] == 'crear_usuario') {
  ...
  $tipo = 2;
  $foto = 'default.jpg';
  $usuario->crear($nombre, $apellido, $edad, $ci, $pass, $tipo, $foto);
}
...
if ($_POST['funcion'] == 'devolver_foto') {
  $usuario->devolver_foto($id_usuario);
  $json = array();
  foreach ($usuario->objetos as $objeto) {
    $json = $objeto;
  }
