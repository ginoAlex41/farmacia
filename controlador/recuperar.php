...
if ($_POST['funcion'] == 'recuperar') {
  ...
  $ci = $_POST['ci'];
  $codigo = generar(10);
  $usuario->remplazar($codigo, $email, $ci);
  ...
  try {
    ...
    $mail->Username   = 'juan.diego.polo.cosme@hotmail.com';                     // SMTP username
    $mail->Password   = 'aqui pones la contraseña de su correo hotmail';                               // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('juan.diego.polo.cosme@hotmail.com', 'Sistema administrativo');
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                     <td style="font-size:12px; padding-top:5px; text-align:center; padding-right:20px">
                       Usuario: <a style="color:red; font-size: 20px;">' . $ci . '</a>
                      </td>
                    </tr>
                  </table>
                </td>
